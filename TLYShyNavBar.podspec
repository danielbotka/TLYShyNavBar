#
#  Be sure to run `pod spec lint TLYShyNavBar.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "Mazyad Alabduljaleel" => "mazjaleel@gmail.com" }
  s.social_media_url   = "http://twitter.com/Mazyod"
